...
### train model: lm(price ~ carat, x, y, z), data = trainData
start_time <- Sys.time()
priceLM <- train(
  price ~ ., 
  data = trainData,
...
hist(diffPrice, breaks=100, main='lm(Price ~ carat, x, y, z)')

# print("lm(Price ~ carat, x, y, z)")
# 
# mean(diffPrice)
# median(diffPrice)
# max(diffPrice)
